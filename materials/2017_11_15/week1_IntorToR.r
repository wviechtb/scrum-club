...
num[1:5]	  # subsets the from the first to the fifth values in the object num
...
list3[[1]]	# reaches the objects inside of the branch
...
list3$nums	# can also use the name of the branch to reach the objects inside of that branch
list3$char
list3$char[1]
